  ...
  return (
    <div>
      ...
      {input ? (
        ...
        <textarea
          className={`p-2 w-full mb-[10px] border-[1px] border-solid border-[#00000080] rounded-[8px] box-border shadow-md text-[16px] bg-[#FAFAFA] focus: outline-none md:h-[121px] md:text-[22px] ${error ? 'border-[#ea3354] focus:border focus:border-solid focus:border-[#ea3354]' : 'focus:border focus:border-solid focus:border-[#86a17c]'}`}
          placeholder={placeholderText}
          value={value}
          onChange={onChange}
        ></textarea>
