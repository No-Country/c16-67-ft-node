...
const HowItWorks = () => {
  return (
    <div className="max-w-[567px] w-full bg-white p-8 mx-auto">
      <p className="text-3xl leading-9 mb-6">How Petgram Works</p>
      ...
      <div className="mb-4">
        <h2 className="text-2xl font-bold mb-2">3. Discover Pet-friendly Places</h2>
        <p>
          Find pet-friendly parks, cafes, and events in your area. Get recommendations from other
          pet owners and make the most of your time with your furry friend.
        </p>
      </div>
      ...
      <p className="text-sm mt-6">Join Petgram today and make your pet a social media star!</p>
    </div>
  );
};
